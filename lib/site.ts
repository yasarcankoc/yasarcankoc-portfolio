// Site geneli sabitler — SEO/metadata tek kaynağı.
// Domain değişirse SADECE burayı güncelle; layout, robots, sitemap ve
// JSON-LD hepsi buradan okuyor.
export const SITE_URL = "https://yasarcankoc.com";
